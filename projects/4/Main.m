...
%%% Results
% Strangely MMSE performs worse than zero-forcing. MMSE not working once
% again comes around to haunt me from my days in Stochastic Signal
% Processing with Prof. Keene.
